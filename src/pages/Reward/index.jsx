      ...
      <MainLayout>
        <div className="main-containe bus-box-con stereo-bxbxb">
          <div className="left-side-container buss-all-container ster-container-man">
            <>
              {showAllRewards && (
                <RewardAll handleShowAlClose={handleShowAlClose} />
              )}
              {showHistory && (
                <RewardHistory
                ...
                <>
                  ...
                  <div className="pay-top-box">
                    <div className="avail-bal-cont flex">
                      ...
                      <div className="view-roy" onClick={handleShowHistory}>
                        View history
                      </div>
                    </div>
                    <div className="coin-bal-view flex">
                      ...
                      <div
                        className={`avail-bal-ivi ${
                          showBalance ? "dis-view" : ""
                        }`}
                      >
                        {showBalance ? "0.00" : "*****"}
                      </div>
                  ...
                  <div className="all-reward-box">
                    <div className="view-all-tic-bx mvwn">
                      ...
                      <div className="view-ll pup" onClick={handleShowAll}>
                        View more
                      </div>
                    </div>
          ...
          <div className="right-side-container right-stereo rith-reward">
