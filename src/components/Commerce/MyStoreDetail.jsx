...
import PromotSale from "../Modals/PromotSale";
const MyStoreDetail = ({ handleProductClose, handleMainContainerClick }) => {
        ...
        <div className="product-main-deatils-box">
          ...
          <div className="product-det-box-con">
            ...
            <div className="desc-cont-body">
              ...
              for sale. A newly open boxed sneakers for sale.A newly open boxed
            ...
            <div className="mess-cart-btns">
              ...
              <button
                className="mess-cart-btn"
                onClick={handleMainContainerClick}
              >
                Edit product
              </button>
            </div>
            <div className="mess-cart-btns pro-btn-bx">
              <button
                className="mess-cart-btn prom-bbbtn"
                onClick={handleSellPromoteClick}
              >
                Promote product
              </button>
            </div>
