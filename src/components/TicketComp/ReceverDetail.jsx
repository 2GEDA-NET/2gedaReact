...
import ChooseTicket from "../../pages/Ticket/ChooseTicket";

const ReceverDetail = ({ receiverDetailRef, eventDetail,handleChooseClick }) => {
  ...
  const [choseTicket, setChoseTicket] = useState(true);
